...
class AnglesConverter(Node):
    def __init__(self):
        ...
        self.euler_to_quaternion_ = self.create_service(EulerToQuaternion, "euler_to_quaternion", self.eulerToQuternionCallback)
    ...
    def eulerToQuternionCallback(self, req, res):
        self.get_logger().info("Requestiong to convert euler angles roll: %f, pitch: %f, yaw: %f, into a quaternion." % (req.roll, req.pitch, req.yaw))
    ...
    def quaternionToEulerCallback(self, req, res):
        self.get_logger().info("Requested to convert quaternion x: %f, y: %f, z: %f, w: %f, into a quaternion." % (req.x, req.y, req.z, req.w))
