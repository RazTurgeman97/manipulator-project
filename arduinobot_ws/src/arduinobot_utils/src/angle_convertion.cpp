...
public:
    AnglesConverter() : Node("angles_convertion_server"){
        ...
        RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Angles convertion services are Ready");
    }
...
private:
    ...
    void eulerToQuaternionCallback(const std::shared_ptr<arduinobot_msgs::srv::EulerToQuaternion::Request> req,
        ...
        RCLCPP_INFO_STREAM(rclcpp::get_logger("rclcpp"), "Request to convert euler angles. roll: " << req->roll << ", pitch: " << req->pitch << ", yaw: " << req->yaw << " into a quternion");
        tf2::Quaternion q;
    ...
    void quaternionToEulerCallback(const std::shared_ptr<arduinobot_msgs::srv::QuaternionToEuler::Request> req,
        ...
        RCLCPP_INFO_STREAM(rclcpp::get_logger("rclcpp"), "Request to convert quaternion angles. x: " << req->x << ", y: " << req->y << ", z: " << req->z << ", w: " << req->w << " into a euler");
